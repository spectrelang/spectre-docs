...
+===================+============================+========================+
| **Option types**  | Recoverable errors         | Returns ``some T`` or  |
|                   |                            | ``none``               |
+-------------------+----------------------------+------------------------+
...
+-------------------+----------------------------+------------------------+
| **Trust markers** | Unverifiable operations    | Propagates trust       |
|                   |                            | requirement            |
+-------------------+----------------------------+------------------------+
| **Type system**   | Type safety                | Compile-time errors    |
+-------------------+----------------------------+------------------------+
| **Mutability      | State safety               | Compile-time errors    |
| rules**           |                            |                        |
+-------------------+----------------------------+------------------------+
...
For more information on testing error conditions, see the :doc:`testing` documentation.
